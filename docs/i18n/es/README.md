...
> Trabaja más duro, luego tómate un descanso. 9 skills para un mejor ritmo de programación con Claude Code.
...
[English](../../../README.md) | [中文](../zh-CN/README.md) | [日本語](../ja/README.md) | [한국어](../ko/README.md) | [Español](README.md) | [Português](../pt-BR/README.md) | [Français](../fr/README.md) | [Deutsch](../de/README.md) | [Русский](../ru/README.md) | [हिन्दी](../hi/README.md) | [Türkçe](../tr/README.md) | [Tiếng Việt](../vi/README.md)
...
| **peer-fuse** | Revisor por pares genérico para md / pdf / docx / pptx (10 formatos) — rúbrica de 8 dim + taxonomía de 18 flags + panel de 3 perspectivas | `/peer-fuse <path>` |
...
| **Multi-sección** | report / checklist / ADR / decision-tree / PoC — `--sections` selecciona secciones; por defecto cada una se genera como su propio archivo `.md`, `--merge` las combina en uno |
...
│   ├── dev-guide/                 # Documentación para desarrolladores
│   ├── design/<category>/         # Documentos de diseño por 4 categorías
│   └── i18n/<lang>/               # Traducciones (README + guías de skill)
├── openspec/                      # Meta-repositorio de evolución
│   ├── specs/<capability>/        # Contratos de capacidad horizontal
│   └── changes/<id>/              # RFCs en curso (archive/ para los completados)
...
2. `platforms/openclaw/<name>/SKILL.md` — Adaptación para OpenClaw + references/scripts (consulta [platform-parity](../../../openspec/specs/platform-parity/spec.md) para el contrato de propagación)
